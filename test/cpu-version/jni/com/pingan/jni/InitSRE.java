...
public class InitSRE extends Pointer
{
	static { Loader.load(); }
	public InitSRE() { allocate(); }
	private native void allocate();
	public native @Cast("bool") boolean ReadUBMFile(@StdString String final_ubm, @StdString String final_ie, @StdString String gmm_ubm);
}
