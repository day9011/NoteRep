...
if __name__ == "__main__":
    ...
    for (k, v) in count_dict.items():
        if v < 2:
            ...
            shutil.move(os.path.join(os.path.abspath(split_file_path), k), os.path.join(os.path.abspath(split_file_path), 'test'))
        elif v == 3:
            shutil.move(os.path.join(os.path.abspath(split_file_path), k), os.path.join(os.path.abspath(split_file_path), 'imposter'))
        else:
            shutil.move(os.path.join(os.path.abspath(split_file_path), k), os.path.join(os.path.abspath(split_file_path), 'train'))
    print "finish split"
