...
if [ $# -ne 4 ]; then
  echo "Usage: $0 [options] <graph-dir> <data-dir> <decode-dir> <nnet2-dir>"
...
data=$2
dir=$3
srcdir=$4; # Assume model directory one level up from decoding directory.
...
echo "--norm-means=false --norm-vars=false" > ${srcdir}/cmvn_opts
